...
#Region " ReadProcessMemory "
    <DllImport(kernel32, EntryPoint:="ReadProcessMemory", SetLastError:=True, CharSet:=CharSet.Unicode)>
    Public Function ReadProcessMemoryW(
        ByVal hProcess As SafeProcessHandle,
...
#Region " SendMessage "
    ...
    Public Function GetHeaderSendMessage(
        ByVal hWnd As IntPtr,
        ByVal message As UInteger,
        ByVal wParam As IntPtr,
...
#End Region
#Region " GetItem "
    Private Function GetItem(ByVal row As Integer, ByVal subitem As Integer,
